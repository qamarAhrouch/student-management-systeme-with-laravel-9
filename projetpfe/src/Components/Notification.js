export default function Notification() {
    return (
        <div className="fixed top-5 right-0 mt-10 mr-10 z-50">
            <div id="toast-notification" className="max-w-xs p-4 text-gray-900 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-300" role="alert">
                ...
                <div className="flex items-center">
                    ...
                    <div className="ms-3 text-sm font-normal">
                        <div className="text-sm font-semibold text-gray-900 dark:text-white">Saad</div>
                        <div className="text-sm font-normal">sent you an email</div> 
                        <span className="text-xs font-medium text-blue-600 dark:text-blue-500">a few min ago</span>   
                    </div>
                ...
                <div className="flex items-center">
                    ...
                    <div className="ms-3 text-sm font-normal">
                        <div className="text-sm font-semibold text-gray-900 dark:text-white">Omar</div>
                        <div className="text-sm font-normal">sent you an email</div> 
